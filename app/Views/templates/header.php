<header class="w-[15%] h-full py-5 z-[9999 bg-white">
    ...
    <div class="w-full bg-white p-4 space-y-2">
        ...
        if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') {
            if ($view == 'categories') { 
                echo '<div class="pt-4 mt-4 border-t border-slate-100 space-y-2"><p class="text-[10px] font-bold text-slate-400 px-3 mb-2">MANAGEMENT</p><a href="cat" class="bg-red-100 text-red-600 w-full flex items-center gap-3 px-3 py-2 rounded-md transition font-medium"><i class="fas fa-tags text-sm"></i> Categories</a>'; 
            } else { 
                echo '<div class="pt-4 mt-4 border-t border-slate-100 space-y-2"><p class="text-[10px] font-bold text-slate-400 px-3 mb-2">MANAGEMENT</p><a href="cat" class="text-slate-600 hover:bg-slate-100 w-full flex items-center gap-3 px-3 py-2 rounded-md transition font-medium"><i class="fas fa-tags text-sm"></i> Categories</a>'; 
            }
            if ($view == 'users') { 
